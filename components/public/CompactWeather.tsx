...
export default function CompactWeather() {
        ...
        async function getWeather() {
            ...
            try {
                ...
                if (myLocation) {
                    ...
                    setWeatherDesc(weatherDict[weatherCode.toString()][isDaytime ? "day" : "night"]);
    ...
    const getTemperatureRange = (): string => {
        if (weatherInfo) {
            if (weatherInfo.maxTemperature !== undefined && weatherInfo.minTemperature !== undefined) {
                return `${Math.round(weatherInfo.maxTemperature)}°C – ${Math.round(weatherInfo.minTemperature)}°C`;
            } else {
